...
fig.savefig('par_att532_15min_comparison.eps', format = 'eps', dpi = 1000)
...
ax.set_ylim([min(min(ss_sample_run[1]), min(ot_sample_run[1]), min(ss_par_sample_run[1])) - 40000, max(max(ss_sample_run[1]), max(ot_sample_run[1]), max(ss_par_sample_run[1])) + 40000])
