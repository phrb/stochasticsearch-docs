...
ax.set_title("TSP (532 Cities) Solution Cost After Tuning for 10 minutes (6 runs)")
ax.set_xlabel("Tuner")
ax.set_ylabel("Solution Cost")

fig.savefig('att532_10min_comparison.png', bbox_inches='tight')
...
fig.savefig('att532_10min_best_ss.png', bbox_inches='tight')
...
fig.savefig('att532_10min_best_ot.png', bbox_inches='tight')
